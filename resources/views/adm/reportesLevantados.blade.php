                ...
                <tbody>
                    @foreach ($data as $dataItem)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <a href="{{route("adm.reportesLevantados.show",$dataItem)}}" class="block text-white  bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-200 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:focus:ring-blue-900">VER</a>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
